...
class TFTDisplay:
    ...
    def _initialize_display(self):
        ...
        self._send_data(0xC0)     # Classic orientation.
        time.sleep(0.1)
...
#         time.sleep(2)
        ...
        display.clear_screen("black")
        display.display_bmp("test.bmp", position=(1, 0))
        time.sleep(2)
        
        print("Displaying BMP image...")
        display.clear_screen("black")
        display.display_bmp("guido_1.bmp", position=(1,0))
        time.sleep(2)

        print("Displaying BMP image...")
        display.clear_screen("black")
        display.display_bmp("guido_mog.bmp", position=(0, 0))
        time.sleep(2)

        print("Displaying BMP image...")
        display.clear_screen("black")
        display.display_bmp("guido_drill.bmp", position=(0, 0))
        time.sleep(2)

        print("Displaying BMP image...")
        display.clear_screen("black")
        display.display_bmp("guido_italy.bmp", position=(0, 0))
        time.sleep(2)
